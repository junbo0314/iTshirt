...
def fit_dirl_gridworld(N_MAPS, lr_weights, lr_maps, max_iters, gamma, seed,
                         trajectories, P_a, bias_goal_map,inherit_maps,lam, REC_DIR_NAME) :
    ...
    for i in range(20):
        ...
        goal_maps_MLEs, losses =  getMAP_goalmaps(seed, P_a, bias_goal_map, trajectories, hyperparams = sigmas, a=weights, 
                                                        goal_maps_init = goal_maps, max_iters=max_iters, lr=lr_maps,
                                                        gamma=gamma, inherit_maps=inherit_maps,bias_lam=lam)
